package com.tapestry.myFirstTapestry.spring;
...
@Configuration
@ComponentScan({ "com.tapestry.myFirstTapestry" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.tapestry.myFirstTapestry");
                servletContext.setInitParameter("tapestry.development-modules", "com.tapestry.myFirstTapestry.services.DevelopmentModule");
